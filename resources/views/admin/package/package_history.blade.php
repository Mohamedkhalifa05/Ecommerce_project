      ...
      <table id="dataTableExample" class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="{{route('admin.package.invoice',$package->id)}}" class="btn btn-inverse-warning" title="Download"><i data-feather="download"></i></a>
                
            </td>
            {{-- <td class=""><input type="hidden" name="name" value="{{$package->user->name}}"></td> --}}
