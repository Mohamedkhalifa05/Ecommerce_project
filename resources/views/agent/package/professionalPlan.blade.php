  ...
  <div class="card-body">
    <div class="container-fluid d-flex justify-content-between">
      ...
      <div class="col-lg-3 pe-0">
        ...
        <h6 class="mb-0 mt-3 text-end fw-normal mb-2"><span class="text-muted">Invoice Date :</span>{{Carbon::now()}} </h6>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr class="text-end">
                ...
                <td class="text-center">Professional plan</td>
