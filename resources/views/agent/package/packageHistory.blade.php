  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>KhalifaShop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               KhalifaShop Head Office
               Email:support@khalifa.com <br>
               Mob: 1245454545 <br>
               Egypt 1207,Mansora:#4 <br>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        ...
        <td align="center">{{ $packagehistory->package_credit }}</td>
