...
@php
    $id = Auth::user()->id;
    $agent_id = App\Models\User::findOrFail($id);
...
<div class="page-content">
  <div class="mb-2">
    @if ($status === "active")
    <h4>This Is Account Is <span class="text-success">Active</span></h4>
@else
<h4>This Is Account Is <span class="text-danger">InActive</span></h4>
    <p class="text-danger"><b>Please wait to check and Approved by Admin</b></p>
@endif
