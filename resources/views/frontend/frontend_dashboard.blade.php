...
<link rel="stylesheet" href="{{asset('frontend/assets/css/Bootstrapv5.3.2.min.css')}}" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
...
{{-- <script src="{{asset('frontend/assets/js/bootstrap1.min.js')}}"></script> --}}
<script src="{{asset('frontend/assets/css/Bootstrapv5.3.2.min.css')}}"></script>
