...
$agents = App\Models\User::where('status','active')->where('role','agent')->orderBy('id','DESC')->limit(5)->get();
 ...
 <section class="team-section sec-pad centred bg-color-1">
  ...
  @foreach($agents as $item)
    <div class="team-block-one d-flex justify-content-center">
        <div class="inner-box text-">
            <figure class="image-box"><img src="{{ (!empty($item->photo)) ? asset($item->photo) : url('upload/no_image.jpg') }}" alt="" style="width:370px; height:370px;" ></figure>
            <div class="lower-content">
                <div class="inner" style="width: 80%;margin-left: 39px;">
