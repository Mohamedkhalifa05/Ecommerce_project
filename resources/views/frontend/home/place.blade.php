            ...
            <div class="items-container row clearfix">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration brand marketing software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img style="width: 370px;height:580px" src="{{ asset($skip_state_0->state_image) }}" alt=""></figure>
                            <div class="text">
                                <h4><a href="{{route("state.details",$skip_state_0->id)}}">{{$skip_state_0->state_name}}</a></h4>
                                @if (count($property_0) == 0)
                                <p></p>  
                                @elseif (count($property_0) > 9)
                                <p>{{count($property_0)}} Properties</p>
                                @else
                                <p>0{{count($property_0)}} Properties</p>
                                @endif
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all brand illustration print software logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img style="width: 370px;height:275px" src="{{ asset($skip_state_1->state_image) }}" alt=""></figure>
                            <div class="text">
                                <h4><a href="{{route("state.details",$skip_state_1->id)}}">{{$skip_state_1->state_name}}</a></h4>
                                @if (count($property_1) == 0)
                                <p></p>  
                                @elseif (count($property_1) > 9)
                                <p>{{count($property_1)}} Properties</p>
                                @else
                                <p>0{{count($property_1)}} Properties</p>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img style="width: 370px;height:275px" src="{{ asset($skip_state_2->state_image) }}" alt=""></figure>
                            <div class="text">
                                <h4><a href="{{route("state.details",$skip_state_2->id)}}">{{$skip_state_2->state_name}}</a></h4>
                                @if (count($property_2) == 0)
                                <p></p>  
                                @elseif (count($property_2) > 9)
                                <p>{{count($property_2)}} Properties</p>
                                @else
                                <p>0{{count($property_2)}} Properties</p>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img style="width:770px;height:275px" src="{{ asset($skip_state_2->state_image) }}" alt=""></figure>
                            <div class="text">
                                <h4><a href="{{route("state.details",$skip_state_3->id)}}">{{$skip_state_3->state_name}}</a></h4>
                                @if (count($property_3) == 0)
                                <p></p>  
                                @elseif (count($property_3) > 9)
                                <p>{{count($property_3)}} Properties</p>
                                @else
                                <p>0{{count($property_3)}} Properties</p>
                                @endif
                            </div>
                        </div>
                    </div>
