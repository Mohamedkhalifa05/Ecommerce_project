...
<div class="inner-box">
    ...
    <div class="lower-content">
        ...
        <ul class="post-info clearfix">
            <li class="author-box">
                <figure class="author-thumb"><img src="{{ (!empty($blog->user->photo)) ? asset($blog->user->photo) : url('upload/no_image.jpg') }}" alt=""></figure>
...
<div class="sidebar-widget category-widget">
    ...
    <div class="widget-content">
        <ul class="category-list clearfix">
            ...
            @php
            $post = App\Models\BlogPost::where("blog_cat_id",$item->id)->get();
            @endphp

            @if (count($post) == 0)
            <li style="visibility: hidden"><a href="{{url('blog/cat/list'.$item->id)}}">{{$item->category_name}}<span>({{count($post)}})</span></a></li>
            @else
            <li><a href="{{url('blog/cat/list/'.$item->id)}}">{{$item->category_name}}<span>({{count($post)}})</span></a></li>  
            @endif
...
<div class="sidebar-widget post-widget">
    ...
    <div class="post-inner">
        ...
        <div class="post">
            <figure class="post-thumb"><a href="{{route('blog.details.side',$post->id)}}"><img src="{{asset($post->post_image)}}" alt=""></a></figure>
            <h5><a href="{{route('blog.details.side',$post->id)}}">{{$post->post_title}}</a></h5>
