            ...
            <div class="auto-container">
                <div class="top-details clearfix">
                    ...
                    <figure class="author-thumb"><img src="{{ (!empty($property->user->photo)) ? asset($property->user->photo) : url('upload/no_image.jpg') }}" alt=""></figure>
                                <h6 style="margin-top: 2px">{{ $property->user->name }}</h6>
                    ...
                    <div class="right-column pull-right clearfix">
                        <div class="price-inner clearfix">
                            <ul style="margin-top: 20px !important;" class="category clearfix pull-left">
        ...
        data-markers='{
            "marker-1": [40.712776, -74.005974, "<h4>Branch Office</h4><p>77/99 New York</p>","{{ asset('frontend/assets/images/icons/map-marker.png') }}"]
                            ...
                            <div class="nearby-box content-widget">
                                {{-- <div class="title-box">
                                    <h4 style="margin-left: -208px">Places</h4>
                                </div> --}}
<div class="inner-box">
    ...
    <div class="single-item">
        ...
        <div class="inner">
            <h5 style="margin-left:-208px">Places:</h5>

            @foreach($facility as $item)
            <div class="box clearfix">
                <div class="text pull-left">
                    <h6 style="margin-left: -192px">{{ $item->facility_name }} <span>({{ $item->distance }} km)</span></h6>
                </div>
...
<figure class="image-box">
   <iframe width="521" height="400" src="{{ $property->property_video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</figure>
                            </div>
    ...
    <div class="property-sidebar default-sidebar">
        <div class="author-widget sidebar-widget">
            <div class="author-box">
              ...
              <figure class="author-thumb"><img src="{{ (!empty($property->user->photo)) ? asset($property->user->photo) : url('upload/no_image.jpg') }}" alt=""></figure>
                <div class="inner" style="width: 100% !important;margin-left: -3px !important;">
                ...
                @else
                        ...
                        @forelse ($related_properties as $item)
