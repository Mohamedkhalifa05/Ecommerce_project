            ...
            <div class="card">
                <div class="card-body">
                                  ...
                                  <form class="forms-sample" method="post"
                                   action="{{route('update.type',$type->id)}}">
                                   ...
                                   <input type="hidden" name="{{$type->id}}" value="{{$type->id}}">
                                      ...
                                      <div class="mb-3">
                                          ...
                                          @error('type_name') isinvalid  @enderror" value="{{$type->type_name}}"  
                                      ...
                                      <div class="mb-3">
                                        ...
                                        @error('type_icon') isinvalid  @enderror"   value="{{$type->type_icon}}" 
                                     ...
                                     <button type="submit" class="btn btn-primary me-3">Update Property Type</button>
                                  </form>
