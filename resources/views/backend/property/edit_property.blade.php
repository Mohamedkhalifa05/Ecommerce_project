     ...
     <button type="submit" class="btn btn-primary">Save Changes </button>
      ...
      <button type="submit" class="btn btn-primary">Save Changes </button>
            ...
            <div class="card-body">
                <h6 class="card-title">Edit Main Multiple Image Image </h6>
                    {{-- <form> --}}
                        ...
                        <form method="post" action="{{route('update.Property.multi_image')}}" id="myForm" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('delete.Property.multi_image',$image->id)}}" id="delete" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
           ...
           {{-- <button type="submit" class="btn btn-primary mt-3">Save Changes </button> --}}
                        ...
                        <form method="post" action="{{route('store.new.multi_image')}}" id="myForm" enctype="multipart/form-data">
                            @csrf
