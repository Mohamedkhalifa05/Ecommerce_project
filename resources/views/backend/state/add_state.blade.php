            ...
            <div class="card">
                <div class="card-body">
                                  ...
                                  <form class="forms-sample" method="post"
                                   action="{{route('store.state')}}" enctype="multipart/form-data">

                                   @csrf
                                     
                                      <div class="mb-3">
                                          <label for="exampleInputPassword1" class="form-label">State Name</label>
                                          <input type="text" name="state_name"  id="state_name" autocomplete="off"
                                          class="form-control
                                    ...
                                    {{ url('upload/no_image.jpg')}}" 
                                     ...
                                     <button type="submit" class="btn btn-primary me-3">Add State</button>
                                  </form>
