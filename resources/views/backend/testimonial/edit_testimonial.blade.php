            ...
            <div class="card">
                <div class="card-body">
                                  ...
                                  <form class="forms-sample" method="post"
                                   action="{{route('update.testimonial')}}" enctype="multipart/form-data">
                                   ...
                                   <input type="hidden" name="testimonial_id" value="{{$testimonial->id}}">
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="text" name="name" value="{{$testimonial->name}}"  id="state_name" autocomplete="off"
                                          class="form-control
                                          @error('name') isinvalid  @enderror"  placeholder="Name">
                                          @error('name')
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" name="position" value="{{$testimonial->position}}"  id="state_name" autocomplete="off"
                                        class="form-control
                                        @error('position') isinvalid  @enderror"  placeholder="Position">
                                        @error('position')
                                        <span class="text-danger mb-1">{{$message}}</span>
                                    @enderror
                                  ...
                                  @enderror
                                    ...
                                    src="{{asset($testimonial->image)}}"
                                     ...
                                     <button type="submit" class="btn btn-primary me-3">Update testimonial</button>
                                  </form>
