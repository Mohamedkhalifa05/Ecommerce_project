          ...
          <div class="col-md-12 grid-margin">
            ...
            <div class="card" >
                <div class="card-body">
                                  ...
                                  <form id="myForm" method="POST" action="{{ route('store.agent') }}" class="forms-sample" enctype="multipart/form-data">
                                  ...
                                  {{-- <form class="forms-sample" method="post"
                                   ...
                                   @csrf
                                    ...
                                    <div class=" form-group mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Agent Image</label>
                                      ...
                                      <br><br>
                                     <button type="submit" class="btn btn-primary me-3">Add Agent</button>
                                  </form>
